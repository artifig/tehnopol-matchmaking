        ...
        <div className="py-12 md:py-20 border-t border-transparent dark:border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-x-8 gap-y-12 sm:grid-cols-2 lg:gap-12 items-start sm:max-w-none md:max-w-2xl lg:max-w-none">
            ...
            <div className="text-center">
              ...
              <blockquote className="text-xl text-gray-600 dark:text-gray-400">“ This is a great app and the value is amazing. I have been using it every quarter! Highly recommend it. “</blockquote>
              <div className="font-red-hat-display font-bold mt-2">
                <cite className="not-italic">—Andy Croll</cite>, <a className="text-orange-500 transition duration-150 ease-in-out" href="#0">Tehnopol.ee</a>
              </div>
            </div>
