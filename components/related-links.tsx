      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-xs sm:max-w-none mx-auto md:max-w-none lg:max-w-none grid gap-4 md:gap-6 sm:grid-cols-2 md:grid-cols-3" data-aos-id-rellinks>
            ...
            {/* 1st item */}
            <a className="flex flex-col items-center text-center p-5 text-white group bg-linear-to-tr from-orange-500 to-orange-400 dark:to-orange-500 shadow-2xl" href="#0" data-aos="fade-down" data-aos-anchor="[data-aos-id-rellinks]">
