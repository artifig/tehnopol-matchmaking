          ...
          <div className="max-w-sm mx-auto grid grid-cols-2 gap-4 gap-y-8 sm:gap-8 md:grid-cols-4 items-start md:max-w-5xl">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative w-20 h-20 mb-3">
                <div className="absolute inset-0 rounded-full opacity-30 bg-linear-to-tr from-orange-500 -z-1" aria-hidden="true"></div>
                <svg className="w-20 h-20 fill-current text-orange-500" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
